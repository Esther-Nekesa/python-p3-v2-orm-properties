...
class Employee:
    ...
    def __init__(self, name, job_title, department_id, id=None):
        self.id = id
        # Calling the setter here for validation on initialization
        self.name = name
    ...
    # --- Properties and Setters for Validation ---
    ...
    def department_id(self, department_id):
        # Check if it's an integer AND if a Department with that ID exists in the DB
    ...
    def save(self):
        ...
        # FIXED: Use type(self) instead of type(cls) to access the class dictionary in an instance method
